...
def convert_ui():
	...
	if len(sys.argv) < 2:
		script_path = "H:\\01-NAD\\Session-06\\_pipeline\\PyQt_Test\\main_window.ui"
	else:
		script_path = sys.argv[1]

	subprocess.Popen(["python.exe", "H:\\01-Preferences-Scripts\\Python_Modules\\PyQt4\\uic\\pyuic.py", ui_path, "-o", main_window_path, "-x"])
