...
mari.menus.addAction(mari.actions.create('Setup HDR', 'Hdr_Manager()'), "MainWindow/Nature")
mari.menus.addAction(mari.actions.create('Clear Cache', 'ClearCache()'), "MainWindow/Nature")