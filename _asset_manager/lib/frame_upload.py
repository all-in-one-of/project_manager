...
for i, url in enumerate(upload_urls):
    ...
    print ("data_size: "+str(data_size) + "data_offset: "+str(data_offset))
    headers = {'Content-Type':file_mime, 'x-amz-acl': 'private'}
    r = requests.put(urlparse.unquote(url), data=data, headers=headers)
